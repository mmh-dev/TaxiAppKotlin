...
class CustomerRegisterActivity : AppCompatActivity() {
    ...
    private val binding: ActivityCustomerRegisterBinding by lazy {
        ActivityCustomerRegisterBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            driverAppLink.setOnClickListener {
                startActivity(
                    Intent(
            ...
            signUp.setOnClickListener {
                val builder = AlertDialog.Builder(this@CustomerRegisterActivity)
                        ...
                        api.enqueue(object: Callback<CreateUserResponse>{
                            override fun onResponse(
                                ...
                                if (response.isSuccessful) {
                                    ...
                                    editor?.apply()
                                    startActivity(Intent(this@CustomerRegisterActivity, CustomerMapsActivity::class.java))
                                }
                            }
